...
<title>Stiglitz — {html.escape(DOMAIN)}</title><style>
...
<div class="header"><h1>Stiglitz — Security Report</h1>
...
<p>Stiglitz — Automated Security Scanner</p></div></div></body></html>"""
...
{phase_section}
<div class="footer">Generated by Stiglitz · Restricted to authorized security teams · CONFIDENTIAL</div>
</body></html>"""
